...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        //这里写你自己的java目录
        gc.setOutputDir("F:\\graduation-project\\graduation-project\\guns\\guns-cinema\\src\\main\\java");
        gc.setFileOverride(true);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("junyong.chen");
        ...
        dsc.setPassword("379859");
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/guns_rest?autoReconnect=true&useUnicode=true&characterEncoding=utf8&useSSL=true&serverTimezone=GMT%2B8");
